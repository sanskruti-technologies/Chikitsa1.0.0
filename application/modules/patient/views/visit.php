...
<!-- Begin Page Content -->
    <div class="container-fluid">
        ...
        <div class="panel-heading expand-collapse-header">
			<h1 class="h3 mb-2 text-gray-800"><i class="fa fa-arrow-circle-up"></i><?php echo $this->lang->line('patient_details');?><?php echo $this->lang->line('clickto_toggle_display');?></h1>
		</div>
    ...
    <div class="container-fluid">
		<!-- Page Heading -->
		<div class="panel-heading expand-collapse-header"><h1 class="h3 mb-2 text-gray-800"><i class="fa fa-arrow-circle-up"></i>
			<?php echo $this->lang->line('new')." ".$this->lang->line('visit'). " " . $this->lang->line('toggle_display');?></h1>
		</div>
    ...
    <div class="container-fluid">
		<!-- Page Heading -->
		<div class="panel-heading expand-collapse-header"><h1 class="h3 mb-2 text-gray-800"><i class="fa fa-arrow-circle-up"></i>
			<?php echo $this->lang->line('visits');?> <?php echo $this->lang->line('toggle_display');?></h1>
		</div>
		<div class="panel-body expand-collapse-content">
			<div class="col-md-12">
