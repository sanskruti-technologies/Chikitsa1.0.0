						...
						<table class="table table-striped table-bordered table-hover" id="nurse_table">
							...
							<tbody>
								...
								<tr <?php if ($i%2 == 0) { echo "class='even'"; } else { echo "class='odd'"; }?> >								
									<td><?php echo $i; ?></td>
									<td><a class="btn btn-info btn-sm square-btn-adjust" href="<?php echo site_url("doctor/nurse_detail/" . $nurse['nurse_id']); ?>"><?php echo  $nurse['title'] . " " .$nurse['first_name'] . " " . $nurse['middle_name'] . " " . $nurse['last_name']; ?></a></td>
									<td>
