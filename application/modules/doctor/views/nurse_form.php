...
$( window ).load(function() {
	...
	<?php if(!isset($nurse_details) || $contacts['contact_image'] == "" || $contacts['contact_image'] == "uploads/images/Profile.png" ){ ?>
...
<?php 
	...
	if(isset($nurse_details)){
		...
		if($nurse_details['joining_date'] != NULL && $nurse_details['joining_date'] != "0000-00-00"){
					...
					<?php } ?>
						...
						<div class="col-md-6">
							<div class="form-group">	
								...
								<?php } ?>
								<?php if(isset($nurse_id) && ( $profile_image!="" ||  $profile_image!="uploads/images/Profile.png")) {?>
								<a class="btn btn-danger btn-sm square-btn-adjust" id="remove_profile_image" data-nurse_id="<?=$nurse_id;?>">Remove Nurse Image</a>
								<?php }?>
