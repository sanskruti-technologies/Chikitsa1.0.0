...
$( window ).load(function() {
	...
	<?php if(!isset($doctor_details) || $contacts['contact_image'] == "" || $contacts['contact_image'] == "uploads/images/Profile.png" ){ ?>
					...
					<?php } ?>
						...
						<div class="col-md-6">
							<div class="form-group">	
								...
								<img id="PreviewImage" src="<?php echo base_url()."/uploads/". $contacts['contact_image']; ?>" alt="<?=$this->lang->line("profile_image");?>"  height="100" />
								<?php }else{ ?>
								<img id="PreviewImage" src="<?php echo base_url()."/uploads/images/Profile.png"; ?>" alt="<?=$this->lang->line("profile_image");?>"  height="100" />
								<?php } ?>
								<?php if(isset($doctor_id) && ( $profile_image!="" ||  $profile_image!="uploads/images/Profile.png")) {?>
								<a class="btn btn-danger btn-sm square-btn-adjust" id="remove_profile_image" data-doctor_id="<?=$doctor_id;?>">Remove Doctor Image</a>
								<?php }?>
