...
INSERT INTO %db_prefix%navigation_menu (menu_name,parent_name,menu_order,menu_url,menu_icon,menu_text,required_module) VALUES ('doctor_preferences', 'doctor', 800, 'doctor/doctor_preference', '', 'Doctor Preferences','doctor');
...
INSERT INTO %db_prefix%menu_access (menu_name, category_name, allow, is_deleted, sync_status) VALUES ('doctor_preferences', 'Doctor', '1', NULL, NULL);
INSERT INTO %db_prefix%menu_access (menu_name, category_name, allow, is_deleted, sync_status) VALUES ('doctor_preferences', 'Administrator', '1', NULL, NULL);
INSERT INTO %db_prefix%menu_access (menu_name, category_name, allow, is_deleted, sync_status) VALUES ('doctor_preferences', 'System Administrator', '1', NULL, NULL);
...
INSERT INTO %db_prefix%menu_access (menu_name,category_name,allow) VALUES ('doctor', 'System Administrator', '1');
INSERT INTO %db_prefix%menu_access (menu_name,category_name,allow) VALUES ('doctor_detail', 'System Administrator', '1');
INSERT INTO %db_prefix%menu_access (menu_name,category_name,allow) VALUES ('department', 'System Administrator', '1');
INSERT INTO %db_prefix%menu_access (menu_name,category_name,allow) VALUES ('fees_detail', 'System Administrator', '1');
INSERT INTO %db_prefix%menu_access (menu_name,category_name,allow) VALUES ('doctor_schdule', 'System Administrator', '1');
INSERT INTO %db_prefix%menu_access (menu_name,category_name,allow) VALUES ('doctor_inavailability', 'System Administrator', '1');
...
UPDATE %db_prefix%modules SET module_version = '0.1.5' WHERE module_name = 'doctor';
-- 0.1.6
UPDATE %db_prefix%modules SET module_version = '0.1.6' WHERE module_name = 'doctor';
