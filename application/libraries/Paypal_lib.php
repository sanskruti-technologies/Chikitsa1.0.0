...
class paypal_lib {
	...
	function paypal_detail($key){
		$sql = "SELECT * FROM ck_data WHERE ck_key = ?"; 
	...
	function __construct()
	{
		...
		$sanbox = $this->paypal_detail('paypal_sandbox');
		$this->paypal_url = ($sanbox == 1)?'https://www.sandbox.paypal.com/cgi-bin/webscr':'https://www.paypal.com/cgi-bin/webscr';
		...
		$businessEmail = $this->paypal_detail('paypal_business');
